package com.test_task.demo.configuration;
...
public class RedisConfiguration {
    ...
    redisOperations(ReactiveRedisConnectionFactory factory) {
        Jackson2JsonRedisSerializer<ExchangeRate> serializer = new Jackson2JsonRedisSerializer<ExchangeRate>(ExchangeRate.class);
